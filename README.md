...
This simple gap follower algorithm won the Grand Prix and set a new Time Trial record of 59s. Team 4 also won the award for having the most CC points out of the 9 teams competing in the RACECAR course.
...
For the Grand Prix, we made three major changes to the algorithm:
- We added a minimum gap size, which prevented the car from following noise when no gap was available. 
- We adjusted the range of the LIDAR scan. Since the course ran clockwise, we made the range of the right side of the car (70deg) more than the left side of the car (60deg). We also increased the range of the EATS speed controller to 100 degrees on each side, which helped in sharp corners.
...
Special thanks to Team 4 (Jason Ma, Jason Zeng, Paul Sopin, Andrew Pan), Chris, the TAs, and the Beaverworks team for making everything possible.
